  ...
  return (
    <div
      className={cn(
        ...
        tool.featured &&
          "rounded-xl bg-gradient-to-br from-yellow-200/70 via-rose-200/60 to-pink-200/70 p-[2px] hover:shadow-[0_8px_24px_rgba(251,191,36,0.18),0_4px_16px_rgba(244,114,182,0.16)]",
      )}
    >
      <Card
        className={cn(
          "relative flex h-full cursor-pointer flex-col border-none shadow-none",
          tool.featured && "rounded-[10px]",
